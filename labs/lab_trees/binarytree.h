...
struct BinaryTree
{
  ...
  private:
     ...
     * @param subRoot The current node in the recursion
     * @effect prints out SUBROOT's left tree, then itself, then its right tree
     */
     ...
     * @effect swaps the left and right branches of SUBROOT
     */
     ...
     * @param subRoot The current node in the recusrion
     * @param path The current path to SUBROOT
     * @effect prints out the path of the current subRoot until a leaf
     */
     ...
     * @param  subRoot the current node in the recursion
     * @return the sum of left tree and right tree distances + 1
     */
    int sumDistances(const Node* subRoot, int currHeight) const;
